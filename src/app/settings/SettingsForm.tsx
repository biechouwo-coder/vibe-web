    ...
    <form ref={formRef} action={handleAction} className="mt-6 space-y-4">
      <div>
        ...
        <input
          ...
          className="mt-1 w-full rounded-lg border border-stone-200 bg-stone-50 px-3 py-2 text-sm outline-none focus:border-[var(--academic-navy)] dark:border-zinc-700 dark:bg-stone-900 dark:text-stone-200"
        />
        {config?.hasToken && (
