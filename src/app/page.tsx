    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-5">
        ...
        <div className="sm:col-span-2 rounded-[var(--radius-panel)] border border-[var(--border)] bg-[var(--background)] p-5">
          ...
          <Link
            href="/plans"
            className="mt-4 flex items-center justify-center rounded-[var(--radius-control)] border border-[var(--border)] bg-[var(--surface)] py-2 text-xs font-semibold uppercase tracking-[0.05em] text-[var(--muted)] transition-colors hover:border-[var(--academic-navy)] hover:text-[var(--academic-navy)]"
          >
            Open task planner
          </Link>
        </div>
      ...
      <section>
        ...
        <div className="rounded-[var(--radius-panel)] border border-[var(--border)] bg-[var(--soft-panel-bg)] p-5">
