  ...
  return (
    ...
    >
      ...
      <form action={deleteTask.bind(null, task.id)}>
        <button type="submit" className="opacity-0 transition-opacity group-hover:opacity-100 rounded p-1 text-stone-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950/30">
